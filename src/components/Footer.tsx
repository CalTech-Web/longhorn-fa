      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            {/* We Accept */}
            <div className="mt-6">
              <h4 className="text-white font-semibold mb-2 text-sm uppercase tracking-wider">We Accept</h4>
              <p className="text-xs text-gray-400 leading-relaxed mb-3">
                Visa, Mastercard, and American Express accepted.
              </p>
              <div className="flex items-center gap-2">
                {/* Visa */}
                <div className="bg-white rounded-md px-2 py-1.5 flex items-center justify-center h-8 w-12">
                ...
                {/* American Express */}
                <div className="bg-[#006FCF] rounded-md px-2 py-1.5 flex items-center justify-center h-8 w-12">
                  <svg viewBox="0 0 780 500" className="h-4 w-auto" xmlns="http://www.w3.org/2000/svg">
